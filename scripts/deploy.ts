...
const main = async() => {
    ...
    const governance = new ethers.Contract("0x4fD54c536325D51a8d6B4EDF1964fb8EABbF3D99", DPexGovernanceAbi, signer) as DPexGovernance;
    ...
    const aggregator = new ethers.Contract("0x978b5ED92CE2a6E3a80b5E999724A2fA989AB44f", DPexFeeAggregatorAbi, signer) as DPexFeeAggregator;
    ...
    // const router = new ethers.Contract("0x616a530CB97E14ABdf59F4cc557c529264EC1e18", DPexRouterAbi, signer) as DPexRouter;
    ...
    await router.initialize("0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f", weth, governance.address, aggregator.address);
